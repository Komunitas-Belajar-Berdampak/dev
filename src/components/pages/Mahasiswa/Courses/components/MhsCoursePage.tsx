...
const MhsCoursePage = () => {
  ...
  const filteredCourses = useMemo(() => {
    ...
    return courses.filter((c) =>
      `${c.kodeMatkul} ${c.namaMatkul}`.toLowerCase().includes(q),
    );
      ...
      <div className="flex flex-wrap items-center justify-between gap-4">
        ...
        <div className="relative" ref={filterRef}>
          ...
          >
            ...
            Filter by
            {hasActiveFilter && (
              <span className="ml-1 rounded-full bg-blue-900 text-white text-[10px] w-4 h-4 flex items-center justify-center">
                !
              </span>
            )}
          </Button>
