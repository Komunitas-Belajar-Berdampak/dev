...
function SidebarProvider({
  ...
  React.useEffect(() => {
    ...
    const mediaQuery = window.matchMedia(`(max-width: ${SIDEBAR_DRAWER_BREAKPOINT - 1}px)`);
    const handleChange = () => {
    ...
    return (
      <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
        <SheetContent
          ...
          data-slot='sidebar'
          data-mobile='true'
          className='bg-sidebar text-sidebar-foreground w-(--sidebar-width) p-0 [&>button]:hidden shadow-none border-none'
          style={
            {
